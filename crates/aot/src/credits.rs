...
impl Credits {
    /// Returns a transaction that allows any staker to bond their microcredits
    /// to a validator.
    pub fn bond_public(
        private_key: &str,
        validator: &str,
    ...
    /// Returns a transaction that any staker to unbond their microcredits from
    /// a validator.
    ...
    /// Returns a transaction that allows any staker to claim their microcredits
    ...
    /// Returns a transaction that allows a validator to set their state to be
    /// either opened or closed to stakers.
    ...
    /// Returns a transaction that transfers public to private credits from the
